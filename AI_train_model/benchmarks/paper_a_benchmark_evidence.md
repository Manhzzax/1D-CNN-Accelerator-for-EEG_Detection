...
1. Every external row is a peer-reviewed primary paper. Its original method
   and protocol must still be checked before using it as a numerical comparator.
...
4. The table contains ictal-detection studies only. Prediction studies remain
