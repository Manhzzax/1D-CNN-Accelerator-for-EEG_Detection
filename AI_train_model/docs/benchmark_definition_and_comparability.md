...
|---|---|---:|---:|---:|
| Current causal screening reference | **EpiSepNet-5K** (`run_21_raw_2s_temporal3`), validation only | 23/29 = 79.31% | 0.467 | 17.0 s |
...
EpiSepNet-5K is the current compact-model reference because it is the first
