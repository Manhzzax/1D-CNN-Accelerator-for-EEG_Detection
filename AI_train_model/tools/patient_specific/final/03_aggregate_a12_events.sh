...
python -m research_path_a_final audit \
  ...
  --event-glob 'outputs/ps_a12_event_ps_a12_chb*_s42/patient_specific_event_replay.json' \
  --output research_v2/reports/path_a/ps_a12_exploratory_full_audit.json
