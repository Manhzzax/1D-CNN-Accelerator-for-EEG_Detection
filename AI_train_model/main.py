...
from scripts import (
    ...
    run_patient_specific_val_threshold_eval,
    run_preprocess,
...
def main():
    ...
    parser.add_argument(
        "--mode", 
        choices=["audit", "checkpoint_eval", "plan", "plan_patient_heldout", "plan_patient_specific", "prepare_patient_specific", "ps_val_threshold_eval", "preprocess", "mine_hard_negatives", "mine_temporal_hard_negatives", "hyperparameter_sweep", "temporal_policy_sweep", "temporal_score_tcn", "eda", "train", "event_eval", "reconcile_event_metrics", "event_diagnostics", "quantize", "export_fpga", "all"],
        default="all",
    ...
    elif args.mode == "ps_val_threshold_eval":
        run_patient_specific_val_threshold_eval.main()
