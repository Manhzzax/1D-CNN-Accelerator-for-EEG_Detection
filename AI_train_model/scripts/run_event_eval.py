...
def main():
    ...
    scaler_mean = np.load(os.path.join(outputs_dir, "scaler_mean.npy"))
    scaler_std = np.load(os.path.join(outputs_dir, "scaler_scale.npy"))
    ...
    print(f"Selected validation threshold: {selected['threshold']:.3f} | target FAR met: {target_met}")
